...
select p.productName, p.quantityInStock from products p where p.productLine like '%Motorcycles%'
order by quantityInStock desc;

select p.productName, p.productLine, p.quantityInStock from products p where productName like '%Ford%'
