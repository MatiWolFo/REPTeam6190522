    ...
    <main>
        <section class="registro">
            <div class="est">
                ...
                <a href="estudiante.html"> <img class="img-est" src="../public/alinyan.png" alt="Estudiante"> </a>
            </div>
            <div class="profe">
                <h2>Profesor</h2>
                <a href="profesor.html"> <img class="img-profe" src="../public/vato.jpg" alt="Profesor"> </a>
            </div>
            <div class="padre">
                <h2>
                    Padre
                </h2>
                <a href="padres.html"><img class="img-padre" src="../public/link.jpg" alt="padre"></a>
            </div>
        </section>
    </main>
    <!--pie de pagina-->
